...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'blog.twig.extension' => 'getBlog_Twig_ExtensionService',
    ...
    /**
     * Gets the 'blog.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Twig\Extensions\BlogExtension A AppBundle\Twig\Extensions\BlogExtension instance.
     */
    protected function getBlog_Twig_ExtensionService()
    {
        return $this->services['blog.twig.extension'] = new \AppBundle\Twig\Extensions\BlogExtension();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ad0a38e1ed3b1206690659de94ee9b67b62210422e9fb4e74af9f24d4f6d1e1c');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('deiss@gardenofconcepts.com');
        $a->setPassword('GScomx1744!');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin('deiss@gardenofconcepts.com', array());
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('blog.twig.extension'));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54d237af3b2eb')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'deiss@gardenofconcepts.com',
            'mailer_password' => 'GScomx1744!',
            'locale' => 'en',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'app.emails.contact_email' => 'contact@email.com',
            'app.comments.latest_comment_limit' => 10,
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'deiss@gardenofconcepts.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'GScomx1744!',
            ...
            'swiftmailer.mailer.default.single_address' => 'deiss@gardenofconcepts.com',
            'swiftmailer.mailer.default.delivery_whitelist' => array(

            ),
            'swiftmailer.spool.enabled' => true,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => 'deiss@gardenofconcepts.com',
